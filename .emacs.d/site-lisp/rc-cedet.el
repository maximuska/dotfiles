;; Origin: Copyright (C) 2003 Alex Ott
;; Author: alexott@gmail.com
;; Status: not intended to be distributed yet

(load-file "~/tmp/cedet-1.0/common/cedet.el")
...
; Project definition
(setq p11.0
      (ede-cpp-root-project "p11.0"
                            :file "/local/home/maximk/p11.0/README"
                            :system-include-path '("/local/home/maximk/p11.0/leia")
                            :local-variables (list (cons 'compile-command "./xtool-p11 build"))))

;; cpp-tests project definition
;; (setq cpp-tests-project
;;       (ede-cpp-root-project "cpp-tests"
;;                             :file
;; "~/projects/lang-exp/cpp/CMakeLists.txt"
;;                             :system-include-path
;; '("/home/ott/exp/include"
;;                                                    boost-base-directory)
;;                             :local-variables (list
;;                                               (cons 'compile-command
;; 'alexott/gen-cmake-debug-compile-string)
;;                                               )
;;                             ))
...
;;                             :local-variables (list
;;                                               (cons 'compile-command
;; 'alexott/gen-std-compile-string)
;;                                               )
;;                             ))

;; ;; my functions for EDE
;; (defun alexott/ede-get-local-var (fname var)
;;   "fetch given variable var from :local-variables of project of file
;; fname"
...
;; ;; (message "AA: %s" cmd)
;;     (set (make-local-variable 'compile-command) (or cmd
;; compile-command))
...
;; (add-to-list 'semantic-lex-c-preprocessor-symbol-file (concat
;qt4-base-dir "/Qt/qconfig-large.h"))
;; (add-to-list 'semantic-lex-c-preprocessor-symbol-file (concat
